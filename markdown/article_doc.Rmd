...
```{r data-processing-pipeline-flowchart-vertical, echo=FALSE, fig.height=27, fig.width=17, out.width="75%", fig.cap= "Flowchart presenting the processing by ProteoScanR. Gold: techniques which involve explanatory data analysis. Yellow: Adjustable features. Blue: Inputs"}
...
```{r ui-numbers-default, echo=F, out.width="100%", fig.cap="Screenshot of proteomics workbench. Summary barplot showing the number of peptide spectrum matches, peptides and proteins"}
...
```{r ui-stat-HC-HIV-noMets, echo=F, out.width="80%", fig.cap="Screenshot of statistics module in portrait mode"}
