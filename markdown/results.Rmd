...
The position of the dot shows the number of matches for the particular gene set. Colors indicate 
for the significance level. In this analysis the entire repertoire of detected proteins was used. Only the gene set collections with the most protein matches were used.
