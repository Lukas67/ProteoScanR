...
```{r data_processing_pipeline_flowchart_vertical, echo=FALSE, fig.height=27, fig.width=17, fig.align='center', fig.cap="Flowchart presenting the processing by ProteoScanR"}
